 ...
 $relationships = array (
  ...
  array (
    ...
    array (
      ...
      2 => 
      array (
        'name' => 'accounts_am_projecttemplates_1_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
  ...
  array (
    ...
    'table' => 'ven1_vendors_accounts_1_c',
    'fields' => 
    array (
      0 => 
      array (
      ...
      4 => 
      array (
        'name' => 'ven1_vendors_accounts_1accounts_idb',
        'type' => 'varchar',
        'len' => 36,
      ),
    ),
    ...
    array (
      0 => 
      array (
        'name' => 'ven1_vendors_accounts_1spk',
        'type' => 'primary',
        'fields' => 
        array (
          0 => 'id',
      ...
      1 => 
      array (
        'name' => 'ven1_vendors_accounts_1_ida1',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'ven1_vendors_accounts_1ven1_vendors_ida',
        ),
      ),
      2 => 
      array (
        'name' => 'ven1_vendors_accounts_1_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'ven1_vendors_accounts_1accounts_idb',
        ),
      ),
    ),
    'lhs_module' => 'ven1_Vendors',
