...
{if !$fields.run_on_import.hidden}
{counter name="panelFieldCount" print=false}
...
{assign var="checked" value=""}
{/if}
<input type="checkbox" class="checkbox" name="{$fields.run_on_import.name}" id="{$fields.run_on_import.name}" value="$fields.run_on_import.value" disabled="true" {$checked}>
{/if}
