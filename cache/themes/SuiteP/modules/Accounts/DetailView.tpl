...
{if !$fields.ven1_vendors_accounts_1_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.ven1_vendors_accounts_1ven1_vendors_ida.value)}
{capture assign="detail_url"}index.php?module=ven1_Vendors&action=DetailView&record={$fields.ven1_vendors_accounts_1ven1_vendors_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="ven1_vendors_accounts_1ven1_vendors_ida" class="sugar_field" data-id-value="{$fields.ven1_vendors_accounts_1ven1_vendors_ida.value}">{$fields.ven1_vendors_accounts_1_name.value}</span>
{if !empty($fields.ven1_vendors_accounts_1ven1_vendors_ida.value)}</a>{/if}
{/if}
...
{if !$fields.customer_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.customer_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.customer_c.name}" value="{ $fields.customer_c.options }">
{ $fields.customer_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.customer_c.name}" value="{ $fields.customer_c.value }">
{ $fields.customer_c.options[$fields.customer_c.value]}
{/if}
{/if}
