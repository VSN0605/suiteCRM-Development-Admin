...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_VEN1_VENDORS_ACCOUNTS_1_FROM_VEN1_VENDORS_TITLE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.ven1_vendors_accounts_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.ven1_vendors_accounts_1_name.name}" size="" value="{$fields.ven1_vendors_accounts_1_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.ven1_vendors_accounts_1_name.id_name}" 
id="{$fields.ven1_vendors_accounts_1_name.id_name}" 
value="{$fields.ven1_vendors_accounts_1ven1_vendors_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.ven1_vendors_accounts_1_name.name}" id="btn_{$fields.ven1_vendors_accounts_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.ven1_vendors_accounts_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"ven1_vendors_accounts_1ven1_vendors_ida","name":"ven1_vendors_accounts_1_name"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.ven1_vendors_accounts_1_name.name}" id="btn_clr_{$fields.ven1_vendors_accounts_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.ven1_vendors_accounts_1_name.name}', '{$fields.ven1_vendors_accounts_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.ven1_vendors_accounts_1_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTOMER' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
<select name="{$fields.customer_c.name}"
id="{$fields.customer_c.name}"
title=''              
>
{if isset($fields.customer_c.value)}
{html_options options=$fields.customer_c.options selected=$fields.customer_c.value}
{else}
{html_options options=$fields.customer_c.options selected=$fields.customer_c.default}
{/if}
</select>
</div>
...
addToValidate('EditView', 'gst_number', 'varchar', false,'{/literal}{sugar_translate label='LBL_GST_NUMBER' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'ven1_vendors_accounts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_VEN1_VENDORS_ACCOUNTS_1_FROM_VEN1_VENDORS_TITLE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'customer_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CUSTOMER' module='Accounts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'ven1_vendors_accounts_1_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Accounts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_VEN1_VENDORS_ACCOUNTS_1_FROM_VEN1_VENDORS_TITLE' module='Accounts' for_js=true}{literal}', 'ven1_vendors_accounts_1ven1_vendors_ida' );
