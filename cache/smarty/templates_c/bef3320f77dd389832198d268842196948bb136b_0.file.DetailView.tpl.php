...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="ven1_vendors_accounts_1_name">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="ven1_vendors_accounts_1_name" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<?php if (!empty($_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1ven1_vendors_ida']['value'])) {
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'default', "detail_url", null);?>index.php?module=ven1_Vendors&action=DetailView&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1ven1_vendors_ida']['value'];
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url'=>$_smarty_tpl->tpl_vars['detail_url']->value),$_smarty_tpl);?>
"><?php }?>
<span id="ven1_vendors_accounts_1ven1_vendors_ida" class="sugar_field" data-id-value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1ven1_vendors_ida']['value'];?>
"><?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['value'];?>
</span>
<?php if (!empty($_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1ven1_vendors_ida']['value'])) {?></a><?php }
}?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="customer_c">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="customer_c" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['customer_c']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>



<?php if (is_string($_smarty_tpl->tpl_vars['fields']->value['customer_c']['options'])) {?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer_c']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer_c']['options'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer_c']['options'];?>

<?php } else { ?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer_c']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer_c']['value'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer_c']['options'][$_smarty_tpl->tpl_vars['fields']->value['customer_c']['value']];?>
