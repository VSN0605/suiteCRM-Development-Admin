...
<div class="col-xs-12 col-sm-12 edit-view-row-item" data-field="ven1_vendors_accounts_1_name">


<div class="col-xs-12 col-sm-2 label" data-label="LBL_VEN1_VENDORS_ACCOUNTS_1_FROM_VEN1_VENDORS_TITLE">
...
ob_start();
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_VEN1_VENDORS_ACCOUNTS_1_FROM_VEN1_VENDORS_TITLE','module'=>'Accounts'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="ven1_vendors_accounts_1_name" colspan='3' >
<?php echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<input type="text" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['name'];?>
" class="sqsEnabled" tabindex="0" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['name'];?>
" size="" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['value'];?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['id_name'];?>
" 
id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['id_name'];?>
" 
value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1ven1_vendors_ida']['value'];?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['name'];?>
" id="btn_<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['name'];?>
...
"
onclick='open_popup(
"<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['module'];?>
", 
600, 
400, 
"", 
true, 
false, 
{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"ven1_vendors_accounts_1ven1_vendors_ida","name":"ven1_vendors_accounts_1_name"}}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['name'];?>
" id="btn_clr_<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['name'];?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label'=>"LBL_ACCESSKEY_CLEAR_RELATE_TITLE"),$_smarty_tpl);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['name'];?>
', '<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['id_name'];?>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $_smarty_tpl->tpl_vars['form_name']->value;?>
_<?php echo $_smarty_tpl->tpl_vars['fields']->value['ven1_vendors_accounts_1_name']['name'];?>
']) != 'undefined'",
		enableQS
);
<?php echo '</script'; ?>
...
<div class="col-xs-12 col-sm-12 edit-view-row-item" data-field="customer_c">


<div class="col-xs-12 col-sm-2 label" data-label="LBL_CUSTOMER">
...
ob_start();
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_CUSTOMER','module'=>'Accounts'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="customer_c" colspan='3' >
<?php echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<select name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer_c']['name'];?>
"
id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer_c']['name'];?>
"
title=''              
>
<?php if ((isset($_smarty_tpl->tpl_vars['fields']->value['customer_c']['value']))) {
echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['fields']->value['customer_c']['options'],'selected'=>$_smarty_tpl->tpl_vars['fields']->value['customer_c']['value']),$_smarty_tpl);?>

<?php } else {
echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['fields']->value['customer_c']['options'],'selected'=>$_smarty_tpl->tpl_vars['fields']->value['customer_c']['default']),$_smarty_tpl);?>
...
' );
addToValidate('EditView', 'gst_number', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_GST_NUMBER','module'=>'Accounts','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'ven1_vendors_accounts_1_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_VEN1_VENDORS_ACCOUNTS_1_FROM_VEN1_VENDORS_TITLE','module'=>'Accounts','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'customer_c', 'enum', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CUSTOMER','module'=>'Accounts','for_js'=>true),$_smarty_tpl);?>
' );
...
', 'campaign_id' );
addToValidateBinaryDependency('EditView', 'ven1_vendors_accounts_1_name', 'alpha', false,'<?php echo smarty_function_sugar_translate(array('label'=>'ERR_SQS_NO_MATCH_FIELD','module'=>'Accounts','for_js'=>true),$_smarty_tpl);?>
: <?php echo smarty_function_sugar_translate(array('label'=>'LBL_VEN1_VENDORS_ACCOUNTS_1_FROM_VEN1_VENDORS_TITLE','module'=>'Accounts','for_js'=>true),$_smarty_tpl);?>
', 'ven1_vendors_accounts_1ven1_vendors_ida' );
<?php echo '</script'; ?>
><?php echo '<script'; ?>
 language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_assigned_user_name']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects['EditView_ven1_vendors_accounts_1_name']={"form":"EditView","method":"query","modules":["ven1_Vendors"],"group":"or","field_list":["name","id"],"populate_list":["ven1_vendors_accounts_1_name","ven1_vendors_accounts_1ven1_vendors_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects['EditView_parent_name']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["EditView_parent_name","parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["parent_id"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects['EditView_campaign_name']={"form":"EditView","method":"query","modules":["Campaigns"],"group":"or","field_list":["name","id"],"populate_list":["campaign_id","campaign_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["campaign_id"],"order":"name","limit":"30","no_match_text":"No Match"};<?php echo '</script'; ?>
>
<?php }
}
