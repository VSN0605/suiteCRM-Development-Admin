<?php
/* Smarty version 4.5.5, created on 2025-11-14 12:35:20
  from 'C:\wamp64\www\crm_folder\testingCRM\cache\themes\SuiteP\modules\AOW_WorkFlow\DetailView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_691722085b8261_82818728',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '35cb1b19752a912e9b56eb7b8ed273d2292bbcab' => 
    array (
      0 => 'C:\\wamp64\\www\\crm_folder\\testingCRM\\cache\\themes\\SuiteP\\modules\\AOW_WorkFlow\\DetailView.tpl',
      1 => 1763123719,
      2 => 'file',
    ),
  ),
...
function content_691722085b8261_82818728 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='AOW_WorkFlow'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='AOW_WorkFlow'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='AOW_WorkFlow'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="flow_module">
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="run_when">
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="flow_run_on">
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="multiple_runs">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="bool" field="multiple_runs" >
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="run_on_import">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="bool" field="run_on_import" >
